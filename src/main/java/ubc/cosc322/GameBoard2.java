...
public class GameBoard2 {
    ...
    public void initFromGameState(ArrayList<Integer> state) {
        ...
        cachedBlackDist = null;  // add this
        cachedWhiteDist = null;  // add this
    }
    ...
    public GameBoard2 withPackedMove(int[] m, int color) {
        GameBoard2 next = this.copy();
    ...
    public int[] computeBfsDist(int color) {
    ...
    public GameBoard2 copy() {
        GameBoard2 gb = new GameBoard2();
